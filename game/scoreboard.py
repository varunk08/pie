...
class Scoreboard():
    ...
    def prepShips(self):
        self.ships = Group()
        for shipNum in range(self.stats.shipsLeft):
    ...
    def prepHighScore(self):
        ...
        self.highScoreImage = self.font.render(highScoreStr, True, self.textColor,
            self.aiSettings.screenBgColor)
    ...
    def prepLevel(self):
        self.levelImage = self.font.render(str(self.stats.level), True,
            self.textColor, self.aiSettings.screenBgColor)
